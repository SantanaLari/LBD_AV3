...
public class consultaFalta {
	...
	public String toString() {
		return "consultaFalta [ra_aluno=" + ra_aluno + ", nome_aluno=" + nome_aluno + ", semana1=" + semana1
				+ ", semana2=" + semana2 + ", semana3=" + semana3 + ", semana4=" + semana4 + ", semana5=" + semana5
				+ ", semana6=" + semana6 + ", semana7=" + semana7 + ", semana8=" + semana8 + ", semana9=" + semana9
				+ ", semana10=" + semana10 + ", semana11=" + semana11 + ", semana12=" + semana12 + ", semana13="
				+ semana13 + ", semana14=" + semana14 + ", semana15=" + semana15 + ", semana16=" + semana16
				+ ", semana17=" + semana17 + ", semana18=" + semana18 + ", semana19=" + semana19 + ", semana20="
				+ semana20 + ", total_faltas=" + total_faltas + "]";
	}
}
